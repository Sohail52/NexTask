      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
        ...
        <header className="h-14 bg-white border-b border-neutral-100 flex items-center justify-between px-4 md:px-6 shrink-0 z-20">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              onClick={toggleTheme}
              className="w-7 h-7 rounded-full flex items-center justify-center border border-neutral-100 text-neutral-500 hover:text-neutral-800 hover:bg-neutral-50 cursor-pointer transition-all dark:border-slate-700 dark:text-slate-400 dark:hover:text-slate-200 dark:hover:bg-slate-800 shrink-0"
            ...
            <Link
              href="/dashboard/profile"
              className="w-7 h-7 rounded-full bg-neutral-900 flex items-center justify-center ring-2 ring-white cursor-pointer hover:ring-neutral-200 transition-all shrink-0"
            >
