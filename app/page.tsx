      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-neutral-100">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={toggleTheme}
              className="w-10 h-10 rounded-full flex items-center justify-center border border-transparent text-neutral-500 hover:text-neutral-800 hover:bg-neutral-50 cursor-pointer transition-all dark:text-slate-400 dark:hover:text-slate-200 dark:hover:bg-[#273449] shrink-0"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-base text-neutral-500 leading-relaxed mb-8 max-w-md">
              NexTask helps developers and teams organize projects, track
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-neutral-400 max-w-md mx-auto">
              Clean, fast, and focused. NexTask looks like the tools you
              already love.
            </p>
          </div>
        ...
        <div className="max-w-2xl mx-auto px-6 text-center">
          <div className="bg-white rounded-2xl border border-neutral-200 shadow-sm p-10">
            ...
            <p className="text-sm text-neutral-400 mb-7 max-w-sm mx-auto leading-relaxed">
              Join developers and students using NexTask to stay on top of
